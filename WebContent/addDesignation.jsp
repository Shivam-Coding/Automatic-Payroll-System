                        ...
                        <div class="widget-content">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form class="form-horizontal" action="Designation?action=addDesignation" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=" col-md-8">
                                                <input type="text" class="form-control" placeholder="Enter Designation" name="adddesignation" required>
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class=" col-md-8">
                                                <input type="text" class="form-control" value="" placeholder="Enter Salary" name="basicsalary" required>
