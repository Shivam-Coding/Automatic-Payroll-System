                        ...
                        <div class="widget-content">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form class="form-horizontal" action="Designation?action=addBenefits" method="post">
	...
	var myselect = document.getElementById("selectDesig").selectedIndex;
	  ...
	  document.getElementById("salary1").value = v;
		  ...
		  document.getElementById("salary1").value = "";
                                          ...
                                          <div class="form-group">
                                            <label class="col-md-4 control-label">House Rent Allowance (HRA)<span style="color:red">*</span>:</label>
                                            <div class=" col-md-8">
                                                <input type="text" class="form-control" placeholder="Enter HRA" name="hra" required>
                                          ...
                                          <div class="form-group">
                                            <label class="col-md-4 control-label">Dearness Allowane (DA):<span style="color:red">*</span>:</label>
                                            <div class=" col-md-8">
                                                <input type="text" class="form-control" placeholder="Enter DA" name="da" required>
                                                 <p class="input-instruction">
                                                     As percentage of Basic Salary
                                                </p>
                                            </div>
                                          ...
                                          <div class="form-group">
                                            <label class="col-md-4 control-label">WA<span style="color:red">*</span>:</label>
                                            <div class=" col-md-8">
                                                <input type="text" class="form-control" placeholder="Enter WA" name="wa" required>
                                                 <p class="input-instruction">
                                                   As percentage of Basic Salary
                                                </p>
                                            </div>
