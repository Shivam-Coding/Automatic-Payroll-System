...
<section class="main-container">
 ...
 if(pay == null){ %>
                                      ...
                                      <form class="form-horizontal" action="PaySlip" method="post">
                                        <input type="hidden" name="action" value="adminPaySlip" >
                                         
                                        
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Enter Employee ID:<span style="color:red">*</span>:</label>
                                            <div class=" col-md-8">
                                                <input type="text" class="form-control" placeholder="Enter Employee ID" name="employeecode" required>
