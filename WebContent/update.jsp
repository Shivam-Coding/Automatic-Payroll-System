                        ...
                        <div class="widget-content">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form class="form-horizontal" action="UpdateSal" method="post">
	...
	var myselect = document.getElementById("selectDesig").selectedIndex;
	  ...
	  document.getElementById("salary1").value = v;
		  ...
		  document.getElementById("salary1").value = "";
                                            ...
                                            <div class=" col-md-8">
                                                <input type="text" class="form-control"  placeholder="Enter Salary" name="basicsalary" id="salary">
                                                <input type ="hidden"  id="salary1"/>
                                            </div>
                                        </div>
