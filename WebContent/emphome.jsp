    ...
    <div class="topbar-left pull-left">
        <div class="clearfix">
            <ul class="left-branding pull-left clickablemenu ttmenu dark-style menu-color-gradient">
                ...
                <li>
                    <div class="logo">
                        <a href="emphome.jsp" title="Employee"><img src="images/logo.png" height="60" width="75" alt="logo"></a>
                    </div>
                </li>
            </ul>
                ...
                <div class="widget-wrap">
                    <div class="widget-header block-header margin-bottom-0 clearfix">
                        <div class="pull-left">
                            ...
                            <p>You can choose from various options here!</p>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="footer-left">
                        <span>Â© 2016 <a href="http://themeforest.net/user/westilian">Pay Me!</a></span>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
